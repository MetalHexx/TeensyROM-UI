...
```typescript
import { interceptSuccess, interceptError, interceptSequence } from './interceptor-primitives';
...
```typescript
const mockDevices = [{ id: 'COM3', name: 'TeensyROM Device', connected: true }];
