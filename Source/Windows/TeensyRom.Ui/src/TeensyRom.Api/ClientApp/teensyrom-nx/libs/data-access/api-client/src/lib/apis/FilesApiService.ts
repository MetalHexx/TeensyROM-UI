...
export class FilesApiService extends runtime.BaseAPI {
  ...
  async removeFavoriteRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RemoveFavoriteResponse>> {
    if (requestParameters['deviceId'] == null) {
      throw new runtime.RequiredError(
        'deviceId',
    ...
    const response = await this.request(
      {
        path: `/devices/{deviceId}/storage/{storageType}/favorite`
          .replace(`{${'deviceId'}}`, encodeURIComponent(String(requestParameters['deviceId'])))
          .replace(
            `{${'storageType'}}`,
            encodeURIComponent(String(requestParameters['storageType']))
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RemoveFavoriteResponseFromJSON(jsonValue)
    );
  }
   ...
   * Save Favorite
   */
  async saveFavoriteRaw(
    requestParameters: SaveFavoriteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SaveFavoriteResponse>> {
    if (requestParameters['deviceId'] == null) {
      throw new runtime.RequiredError(
        'deviceId',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SaveFavoriteResponseFromJSON(jsonValue)
    );
  }
  ...
  async searchRaw(
    ...
    const response = await this.request(
      {
        path: `/devices/{deviceId}/storage/{storageType}/search`
          .replace(`{${'deviceId'}}`, encodeURIComponent(String(requestParameters['deviceId'])))
          .replace(
            `{${'storageType'}}`,
            encodeURIComponent(String(requestParameters['storageType']))
