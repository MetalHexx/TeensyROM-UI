...
export class FilesService extends BaseService {
     ...
     */
    public devicesDeviceIdStorageStorageTypeDirectoriesGet(deviceId: string, storageType: number, path?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<GetDirectoryResponse>;
    public devicesDeviceIdStorageStorageTypeDirectoriesGet(deviceId: string, storageType: number, path?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GetDirectoryResponse>>;
    public devicesDeviceIdStorageStorageTypeDirectoriesGet(deviceId: string, storageType: number, path?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GetDirectoryResponse>>;
    public devicesDeviceIdStorageStorageTypeDirectoriesGet(deviceId: string, storageType: number, path?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/devices/${this.configuration.encodeParam({name: "deviceId", value: deviceId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/storage/${this.configuration.encodeParam({name: "storageType", value: storageType, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: undefined})}/directories`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public devicesDeviceIdStorageStorageTypeIndexPost(deviceId: string, storageType: number, startingPath?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<IndexResponse>;
    public devicesDeviceIdStorageStorageTypeIndexPost(deviceId: string, storageType: number, startingPath?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<IndexResponse>>;
    public devicesDeviceIdStorageStorageTypeIndexPost(deviceId: string, storageType: number, startingPath?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<IndexResponse>>;
    public devicesDeviceIdStorageStorageTypeIndexPost(deviceId: string, storageType: number, startingPath?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (deviceId === null || deviceId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public devicesDeviceIdStorageStorageTypeLaunchPost(deviceId: string, storageType: number, filePath: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<LaunchFileResponse>;
    public devicesDeviceIdStorageStorageTypeLaunchPost(deviceId: string, storageType: number, filePath: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<LaunchFileResponse>>;
    public devicesDeviceIdStorageStorageTypeLaunchPost(deviceId: string, storageType: number, filePath: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LaunchFileResponse>>;
    public devicesDeviceIdStorageStorageTypeLaunchPost(deviceId: string, storageType: number, filePath: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (deviceId === null || deviceId === undefined) {
