import { Component, input, inject, computed, signal, effect, untracked, viewChild } from '@angular/core';
import { CommonModule } from '@angular/common';
import { ScalingCompactCardComponent, InputFieldComponent, IconButtonComponent } from '@teensyrom-nx/ui/components';
...
export class SearchToolbarComponent {
  ...
  readonly canSearch = computed(() => 
    this.searchText().trim().length > 0 && !this.isSearching()
  );
