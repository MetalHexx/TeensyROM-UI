...
export class PlayerApiService extends runtime.BaseAPI {
    ...
    async launchFileRaw(requestParameters: LaunchFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LaunchFileResponse>> {
        ...
        const response = await this.request({
            path: `/devices/{deviceId}/storage/{storageType}/launch`.replace(`{${"deviceId"}}`, encodeURIComponent(String(requestParameters['deviceId']))).replace(`{${"storageType"}}`, encodeURIComponent(String(requestParameters['storageType']))),
            method: 'POST',
    ...
    async launchRandomRaw(requestParameters: LaunchRandomRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LaunchRandomResponse>> {
        ...
        const response = await this.request({
            path: `/devices/{deviceId}/storage/{storageType}/random-launch`.replace(`{${"deviceId"}}`, encodeURIComponent(String(requestParameters['deviceId']))).replace(`{${"storageType"}}`, encodeURIComponent(String(requestParameters['storageType']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async toggleMusicRaw(requestParameters: ToggleMusicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ToggleMusicResponse>> {
        ...
        const response = await this.request({
            path: `/devices/{deviceId}/toggle-music`.replace(`{${"deviceId"}}`, encodeURIComponent(String(requestParameters['deviceId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
