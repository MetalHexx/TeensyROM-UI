    ...
    public class MidiSettings
    {
        ...
        public void InitMappings()
        {
            ...
            [
                ...
                new CCMapping()   { DJEventType = DJEventType.CurrentSpeed, DisplayName = "Inc/Dec Speed %", RelativeType = RelativeCCType.Relative1, AmountEnabled = true, Amount = 0.1 },
                new CCMapping()   { DJEventType = DJEventType.CurrentSpeedFine, DisplayName = "Inc/Dec Speed Fine %", RelativeType = RelativeCCType.Relative1, AmountEnabled = true, Amount = 0.01 },
